<!--
  Public-facing README for the SEPARATE public repo `vorn-forecast`.
  Copy this file's content into that repo's README.md and add real screenshots
  (see the "Screenshots" section below — replace the placeholder line with
  actual images once exported, e.g. from the phone mockups on the landing page).
...
Progressive Web App built with **Next.js, React and TypeScript**. Local-first storage with an
optional encrypted cloud sync. No tracking, no advertising.
...
- **Website / Live Demo:** [vornforecast.com](https://www.vornforecast.com)
- **Launch the App:** [app.vornforecast.com](https://www.app.vornforecast.com)
...
In active development. Public preview of the product; the source code is kept private.
